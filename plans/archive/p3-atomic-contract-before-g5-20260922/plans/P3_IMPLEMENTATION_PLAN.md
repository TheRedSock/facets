...
**Successor direction, 2026-09-21:** first execute
[P3_READINESS_SUCCESSOR.md](P3_READINESS_SUCCESSOR.md). The user selected repeated
merge-window input before pending automatic matches and isolated default-path
lookahead. The atomic-only activation/scope wording below is retained historical
preparation, superseded for the next implementation route. G5 reconciles its
family scopes, Craft, rollback, save phases and protocol identities; room/content
work below remains P3 scope. No successor feature has been implemented yet.
