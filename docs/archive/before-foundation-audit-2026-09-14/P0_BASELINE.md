...
Keep AGENTS.md as the current implementation/invariant authority. When the relevant code changes land, update the named sections with its regression evidence. P0 records these edits without falsely documenting future behavior as current.

| Section | Deliberate future edit | Milestone |
|---|---|---|
