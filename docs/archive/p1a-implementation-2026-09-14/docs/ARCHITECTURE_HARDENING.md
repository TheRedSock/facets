...
Neither later phase substitutes for a usable foundation. A separately approved
reactive-window trial may follow the P2 room, before P3 save/reaction contracts
freeze; it does not block the concurrent-motion repair.
