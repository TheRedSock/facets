...
**Successor proposal, 2026-09-21:** the user has requested
[merge-window P3 readiness](P3_READINESS_SUCCESSOR.md), with incremental work and
discardable default-result lookahead. Its proposed exits measure end-to-end
animation deadlines and main-thread headroom. This changes the intended next
engineering goal; it does not pass the old whole-action 5 ms target or claim new
measurements. Preserve the evidence and original disposition below. Freeze and
verify successor thresholds at G0/G6, then record a new readiness ledger at G7.
