...
“Facets” is a working project codename, not a selected game title or a creative
brief. Do not derive a compulsory visual motif, story or world from it. Gemology
and gemstone collection are user anchors in their own right. Develop the strongest
experience first; retain or propose a different title when the direction warrants
it. Repository identifiers need not change during exploration.
