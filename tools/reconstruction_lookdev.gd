...
func _initialize() -> void:
	...
	for item in 4:
		...
		for variant in 2:
			...
			raw_images.append(tracer.finalize_print(GemPrint.load_house(),false,1,Vector2i.ZERO,false))
			...
			if variant==1:
				...
				high=tracer.finalize_print(GemPrint.load_house(),false,1,Vector2i.ZERO,false)
