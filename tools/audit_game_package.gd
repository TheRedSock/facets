...
const ALLOWED_ROOTS := ["autoloads/", "core/board/", "core/rules/", "core/run/", "core/delivery/", "resources/definitions/", "resources/delivery/", "data/tiles/", "data/game/rules/", "data/presentation/", "scenes/board/", "scenes/tile/", "scenes/run/", "scenes/main/", "scenes/menu/", "scenes/debug/"]
