...
foreach ($name in @('test_foundation', 'test_geometry', 'test_boundaries', 'test_factory', 'test_store_maintenance', 'test_spectra', 'test_material_inputs', 'test_species_data', 'test_pleochroism', 'test_clips', 'test_board_consumer', 'test_cut_compiler')) {
