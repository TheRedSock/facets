...
if ($ReferencePython -and $failed.Count -eq 0) {
    $referenceChecks = @('check_polarization_reference', 'check_crystal_modes_reference', 'check_crystal_interface_reference', 'check_crystal_packet_reference')
