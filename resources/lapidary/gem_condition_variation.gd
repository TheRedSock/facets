...
@export_enum("finish.alpha_u", "finish.alpha_v", "rounding.radius_mm", "cleavage.depth_mm", "workmanship.azimuth_error_deg", "workmanship.polar_error_deg", "workmanship.inward_offset_mm", "workmanship.girdle_inward_mm", "material.scatter_per_mm", "material.scatter_g", "population.count") var target := "finish.alpha_u"
